...
namespace ADFSTk
{
    public class RefedsSFAUsernamePasswordAdapter : IAuthenticationAdapter
    {
        ...
        public IAuthenticationAdapterMetadata Metadata => new RefedsSFAUsernamePasswordMetadata();
