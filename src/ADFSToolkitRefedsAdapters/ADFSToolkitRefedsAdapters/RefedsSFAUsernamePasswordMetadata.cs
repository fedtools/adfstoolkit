...
namespace ADFSTk
{
    public class RefedsSFAUsernamePasswordMetadata : IAuthenticationAdapterMetadata
    {
        ...
        public RefedsSFAUsernamePasswordMetadata()
        {
        ...
        {
            get { return GetMetadataResource(Constants.ResourceNames.AdminFriendlyNameSFA, CultureInfo.CurrentUICulture.LCID); }
        }
