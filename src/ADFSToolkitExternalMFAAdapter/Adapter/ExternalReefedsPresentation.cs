...
{
    internal class ExternalReefedsPresentation : IAdapterPresentationForm
    {
        ...
        public ExternalReefedsPresentation(string username, string proxyUrl,string trustedUrl)
        {
            _username = username;
            _url = proxyUrl;
            _trustedUrl = trustedUrl;
        }
        public ExternalReefedsPresentation(string username, string url, ExternalAuthenticationException ex) : this(username, url,string.Empty)
        {
            _ex = ex;
            _url = url;
        }
